...
<head>
    ...
    <link rel="stylesheet" href="../ss/zpwd/sui.css" />
    ...
    <div class="ng-toolbar-con wrapper">
        <div class="ng-toolbar-left">
            <a  class="ng-bar-node ng-bar-node-backhome" id="ng-bar-node-backhome" style="display: block;">
                <span><img src="../static/img/Home.png" style="margin-right: 10px;"/>返回买啦首页</span>
            </a>
            <div class="ng-bar-node-box ng-site-nav-box">
                <a href="" class="ng-bar-node ng-bar-node-site" >
                    <span><img src="../static/img/daohang.png" style="margin-right: 5px;" />网站导航</span><em class="ng-iconfont down"></em>
                </a>
        ...
        <div class="ng-toolbar-right">
            ...
            <a class="ng-bar-node ng-bar-node-mini-cart"  rel="nofollow" href="">
                <span><img src="../static/img/购物车.png" />&nbsp;购物车</span>
    ...
    <div class="cont">
            ...
            <div class="ms-side">
                <article class="side-menu side-menu-off">
                    <dl class="side-menu-tree">
                        ...
                        <dd><a href="${request.contextPath}/sellManager/SellAdd"><span ></span>发布商品</a></dd>
                        ...
                        <dd><a href="${request.contextPath}/sellManager/SellOrder" style="color:#f70"><span class="active"></span>已卖出的商品</a>
        ...
        <div class="yz-div-box">
            ...
            <div  style="margin-top: 5px">
                <form name="sellFindOrder" action="/sellFindOrder" >
                    <div >
                        <#--商品查询出来的是包含改商品的总单-->
                    ...
                    <div >
                        <div class="yz-input1">买家名称：<input type="text" name="userId"/></div>
                        <div class="yz-input2">订单编号：<input type="text" name="orderNum"></div>
                    </div>
                    <div ><input  type="submit" value="搜索订单"><div>
                </form>
            </div>
            <div class="yz-title" >
                <div class="yz-tab3" ><span class="yz-span1" style="color: #f88600;border-bottom:1px #f88600 solid"><a href="/sellManager/OrderWait?5">近三个月订单</a></span><span class="yz-span2"></span></div>
                <div class="yz-tab2"><span class="yz-span1"><a href="${request.contextPath}/sellManager/OrderWait?1">等待付款</a></span><span class="yz-span2"></span></div>
                <div class="yz-tab2"><span class="yz-span1"><a href="${request.contextPath}/sellManager/OrderWait?2">等待发货</a></span><span class="yz-span2"></span></div>
                <div class="yz-tab1" ><span class="yz-span1"><a href="${request.contextPath}/sellManager/OrderWait?3">已发货</a></span><span class="yz-span2"></span></div>
                <div class="yz-tab2"><span class="yz-span1"><a href="${request.contextPath}/sellManager/OrderWait?4">成功的订单</a></span><span class="yz-span2"></span></div>
                <div class="yz-tab4"><span class="yz-span1"><a href="${request.contextPath}/sellManager/OrderWait?6">三个月以前的订单</a></span></div>
            </div>
            ...
            <table class="yz-table-box">
                ...
                <#list OrderList>
                    <#items  as ord>
                        <td>
                            <div class="yz-table-td-div2" style="height: ${ord.orderDetails?size*70+25}px">
                                <div class="yz-table-td-div">
                                    <!--订单号 订单生成时间 -->订单号：${ord.orderNum} 创建时间：${ord.createTime}
                                </div>
                                <table >
                        <#list ord.orderDetails>
                            <#items as det>
                                    <tbody class="list-table">
                                    <td class="list-table-body-td1" style="text-align: left">
                                        <img src="${det.product.proUrl}"><a href="${request.contextPath}/sellManager/OrderDetails?${ord.orderId}">${det.product.proName}</a>
                                    </td>
                                    <td class="list-table-body-td2">${det.product.proPrice}</td>
                                    <td class="list-table-body-td2">${det.count}</td>
                                    <td class="list-table-body-td2"></td>
                                    <td class="list-table-body-td3"><#if det_index ==0>
                                        ${ord.user.userName} </#if></td>
                                    <td class="list-table-body-td4" ><p></p>
                                     <#if det_index ==0>
                                        <#if ord.status==1>
                                            等待付款
                                        <#elseif ord.status==2>
                                            <p style="color: red"> 已经付款</p>
                                        <a href="${request.contextPath}/sellManager/OrderDetails?${ord.orderId}" style="font-size: 10px">前往发货页面</a>
                                        <#elseif ord.status==3>
                                            等待确认
                                        <#elseif ord.status==4>
                                            已经结束
                                    ...
                                    <td class="list-table-body-td4"><#if det_index ==0>${ord.cost}</#if></td>
                                    <td class="list-table-body-td5">
                                        <#list ord.proScores>
                                            <#items as scores>
                                                <#if   scores.score==1>
                                                好评
                                                <#elseif scores.score==2>
                                                中评
                                                <#elseif scores.score==3>
                                                差评
                                                <#else >
                                                尚未评价
                                                </#if>
