            ...
            <form enctype="multipart/form-data" class="manage" method="post" action="${request.contextPath}/sellManager/addProduct">
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="pcId1" name="pcId1">
                                <#list CateList>
                                    <#items as cate>
                                        <option value=${cate.pcId}>${cate.pcName}  </option>
                                    </#items>
                                </#list>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px"><input type="text" class="text tiny" name="proPrice"/> 元</td>
                    </tr>
                    <tr>
                        <td class="field">优惠价：</td>
                        <td  style="font-size: 12px"><input type="text" class="text tiny" name="newPrice"/> 元</td>
                        </td>
                    </tr>
                    <tr>
