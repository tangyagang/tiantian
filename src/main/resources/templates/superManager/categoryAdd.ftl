    ...
    <div class="cont">
            ...
            <div class="ms-side">
                <article class="side-menu side-menu-off">
                    <dl class="side-menu-tree">
                        ...
                        <dd><a href="${request.contextPath}/superManager/categoryAdd" style="color:#f70"><span class="active"></span>类别添加</a></dd>
        ...
        <div class="yz-div-box">
            ...
            <div style="position:absolute;height: 150px;width: 1068px;top:50%;left:35%">
                <div>
                    <form action="${request.contextPath}/superManager/addProductCategory" method="post" class="yz-category-from">
                        <table class="">
                            <tr>
                                <td class="">一级分类：</td>
                                <td>
                            ...
                            <tr >
                                ...
                                <td>
                                    <select class="two_type" name="parentId">
                                        <#list list[0].productCategorys as productCategory>
                                            <option value="${productCategory.pcId}">${productCategory.pcName}</option>
                                        </#list>
                                    </select>
                                </td>
                            ...
                            <tr>
                                <td class="">三级分类：</td>
                                <td>
                                    <input type="text" class="text" name="pcName"/>
