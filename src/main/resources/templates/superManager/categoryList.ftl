    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".yz-input3").click(function () {
                pcName = $("input:text[name=pcName]").val();
                pageNo = $("input:hidden[name=pageNo]").val();
                window.location.href="${request.contextPath}/superManager/categoryList?pcName="+pcName;
            });
            //分页
            $("#first_page").click(function(){
                ...
                if(pageNo > 1){
                    pageNo = 1;
                    $("#current").val(pageNo);
                    window.location.href="${request.contextPath}/superManager/categoryList?pageNo="+pageNo+"&pcName="+pcName;
                }
            })
        ...
        function delProductCategory(pcId) {
            ...
            if (flag){
                $.get("${request.contextPath}/superManager/delProductCategory?pcId="+pcId,function (data) {
                    if (data){
                        alert("删除成功！");
                        window.location.href="${request.contextPath}/superManager/categoryList";
                    } else {
                        alert("删除失败！");
                    }
                });
...
<div id="yz-center" class="personal-member">
    <div class="cont">
            ...
            <div class="ms-side">
                <article class="side-menu side-menu-off">
                    <dl class="side-menu-tree">
                        ...
                        <dd><a href="${request.contextPath}/superManager/categoryList" style="color:#f70"><span class="active"></span>分类列表</a></dd>
        ...
        <div class="yz-cate-div-box">
            <dl>分类列表</dl>
            <div style="margin-top: 5px">
                <from>
                    <div style="margin-top: 5px">
                        <div>
                            <div class="yz-input1">分类名称 ：<input type="text" value="<#if pcName??>${pcName}</#if>" name="pcName"/></div>
                            <input class="yz-input3" type="button" value="搜索分类">
                        </div>
                    </div>
                </from>
            </div>
            <table class="yz-cate-table">
                <thead>
                <table class="yz-cate-title">
                    <tbody>
                    <tr class="yz-cate-table-tr1">
                        <td class="list-cate-td1">分类ID</td>
                        <td class="list-cate-td2">一级分类</td>
                        <td class="list-cate-td2">二级分类</td>
                        <td class="list-cate-td2">三级分类</td>
                        <td class="list-cate-td1">修改</td>
                        <td class="list-cate-td1">删除</td>
                    </tr>
                    </tbody>
                </table>
                </thead>
                ...
                <tbody>
                    <td>
                    <#list pageInfo.list as productCategory3 >
                        <div class="yz-cate-table-div">
                            <table>
                                <tbody class="yz-cate-table-list">
                                <td class="list-cate-body-td1"><#if productCategory3??>${productCategory3.pcId}</#if></td>
                                <td class="list-cate-body-td2">
                                    <#if productCategory3??>
                                        <#if productCategory3.productCategory??>
                                            <#if productCategory3.productCategory.productCategory??>
                                                ${productCategory3.productCategory.productCategory.pcName}
                                            </#if>
                                        </#if>
                                    </#if>
                                </td>
                                <td class="list-cate-body-td2">
                                    <#if productCategory3??>
                                        <#if productCategory3.productCategory??>
                                            ${productCategory3.productCategory.pcName}
                                        </#if>
                                    </#if>
                                </td>
                                <td class="list-cate-body-td2"><#if productCategory3??>${productCategory3.pcName}</#if></td>
                                <td class="list-cate-body-td1"><a href="${request.contextPath}/superManager/categoryModify?pcId=${productCategory3.pcId}">修改</a></td>
                                <td class="list-cate-body-td1" onclick="delProductCategory(${productCategory3.pcId})"><a href="javascript:void(0)">删除</a></td></td>
                                </tbody>
                            </table>
                        </div>
                    </#list>
