...
<head>
    ...
    <link rel="stylesheet" href="../css/yz - 副本.css"/>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".yz-input3").click(function () {
                ...
                proName = $("input:text[name = proName]").val();
                pageNo = $("input:hidden[name=pageNo]").val();
                window.location.href=
                        "${request.contextPath}/superManager/superOrderList?search"+search+"&proName="+proName;
            });
            //分页
            $("#first_page").click(function(){
                ...
                if(pageNo > 1){
                    ...
                    $("#current").val(pageNo);
                    window.location.href=
                            "${request.contextPath}/superManager/superOrderList?pageNo="+pageNo+"&search="+search+"&proName="+proName;
                }
            })
        ...
        function closeOrder(orderId) {
            var flag = confirm("确定是否关闭订单!");
            if (flag){
                $.get("${request.contextPath}/superManager/closeOrder?orderId="+orderId,function (data) {
                    if (data){
                        window.location.href="${request.contextPath}/superManager/superOrderList";
                    } else {
                        alert("订单关闭失败！");
                    }
                });
    ...
    <div class="cont">
            ...
            <div class="ms-side">
                <article class="side-menu side-menu-off">
                    <dl class="side-menu-tree">
                        ...
                        <dd><a href="${request.contextPath}/superManager/superOrderList" style="color:#f70"><span class="active"></span>订单列表</a>
                    </dl>
        ...
        <div class="yz-div-box">
            ...
            <div style="margin-top: 5px">
                <form id="form">
                    <div>
                        <div class="yz-input1">商品名称：<input type="text" value="<#if superOrderListSearch.proName??>${superOrderListSearch.proName}</#if>" name="proName"/></div>
                        <div class="yz-input2">订单编号：<input type="text" value="<#if superOrderListSearch.orderNum??>${superOrderListSearch.orderNum}</#if>" name="orderNum"></div>
                    </div>
                    <div>
                        <div class="yz-input1">买家名称：<input type="text" value="<#if superOrderListSearch.userName??>${superOrderListSearch.userName}</#if>" name="userName"/></div>
                        <div class="yz-input2">商店名称：<input type="text" value="<#if superOrderListSearch.shopName??>${superOrderListSearch.shopName}</#if>" name="shopName"></div>
                    </div>
            ...
            <table class="yz-table-box">
                ...
                <table class="yz-table">
                    ...
                    <tr class="list-table-tr1">
                        ...
                        <td class="yz-super-list-table-td1">数量</td>
                        <td class="yz-super-list-table-td2">单价</td>
                        <td class="yz-super-list-table-td4">总计金额</td>
                        <td class="yz-super-list-table-td4">卖家名称</td>
                        <td class="yz-super-list-table-td4">交易状态</td>
                        <td class="list-table-td6">操作</td>
                    </tr>
                    </tbody>
                </table>
                </thead>
                ...
                <td>
                    <div class="yz-table-td-div2">
                        ...
                        <#list pageInfo.list as order>
                            <div class="yz-super-table-td-div">
                                <div style="float: left;">
                                    买家名称：${order.user.userName} &nbsp&nbsp订单总金额：${order.cost}
                                </div>
                                <div style="text-align: right;margin-top: 2px">
                                    您订单中的商品在不同库房或属不同商家，已拆分为以下订单
                                </div>
                            </div>
                            <table>
                                <div class="yz-super-table-td-div">
                                    <div class="yz-table-td-div-1">
                                        <!--订单号 订单生成时间 -->订单号：${order.orderNum}
                                        创建时间：${order.createTime?string("yyyy-MM-dd")}
                                    </div>
                                    <div class="yz-table-td-div-2">
                                        <!--店铺名称-->${order.orderDetails[0].shop.shopName}
                                    </div>
                                </div>
                                <#list order.orderDetails as orderDetail>
                                    <tr>
                                        <div class="yz-super-list-table">
                                            <td class="yz-super-list-table-body-td1" style="text-align: left"><img style="width:46px;height: 40px;"
                                                    src="${request.contextPath}/${orderDetail.product.proUrl}"><a
                                                    href="">${orderDetail.product.proName}</a></td>
                                            <td class="yz-super-list-table-body-td6">${orderDetail.count}</td>
                                            <td class="yz-super-list-table-body-td2">${orderDetail.product.proPrice}</td>
                                        </div>
                                        <!--下面这个DIV只在第一次循环中列数据-->
                                        <div class="yz-super-list-table2">
                                            <td class="yz-super-list-table-body-td3">${order.cost}</td>
                                            <td class="yz-super-list-table-body-td4">${orderDetail.shop.user.userName}</td>
                                            <td class="yz-super-list-table-body-td4" style="color: #f88600">
                                                <p>
                                            ...
                                            <td class="yz-super-list-table-body-td5"><a href="javascript:void(0)" onclick="closeOrder(${order.orderId})" style="color: #0e90d2">关闭订单</a></td>
                                        </div>
                                    </tr>
                                </#list>
                            </table>
