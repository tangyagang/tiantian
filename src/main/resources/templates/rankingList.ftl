...
<title>排行榜</title>
<link href="css/ranking_list.css" type="text/css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".s_btn").click(function () {
                ...
                window.location.href="${request.contextPath}/rankingList?proName="+proName;
            });
            //分页
            $("#first_page").click(function(){
                ...
                if(pageNo > 1){
                    pageNo = 1;
                    $("#current").val(pageNo);
                    window.location.href="${request.contextPath}/rankingList?pageNo="+pageNo+"&proName="+proName;
                }
            })
        ...
        <div class="test2">
            <div class="A1">
                 <#if user??>
                    ...
                    <a href="${request.contextPath}/exit?msg=rankingList">退出登录</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                 <#else >
            ...
            <div class="head_nav_main">
              <div class="head_nav_main1"> 
                ...
                <a href="${request.contextPath}/index"> 品牌团 </a> <a href="#" class="head_index_for">积分商城</a>
             </div>
    </div>
</header>
<!--中间部分-->
<section class="center_class">
	<div class="pictrue"><img src="img/top_banner_85986.jpg" /></div>
