        ...
        <div class="cont-main">
            <div class="main-wrap mt15">
                ...
                <div class="main-wrap-main">
                    ...
                    <form method="post" name="user" action="${request.contextPath}/adminManager/userImgModify"
                        ...
                        <div class="user-profile clearfix">
                            <div class="user-profile-wrap">
                                ...
                                <div class="profile-avatar">
                                    ...
                                    <img src="<#if user.userUrl??>${request.contextPath}/${user.userUrl}</#if>" height="200" width="200">
                                </div>
                            </div>
                        </div>
