    ...
    <div class="cont">
        ...
        <div style="margin-top: 30px;width: 1068px; margin: 15px 0 30px 170px;">
            <dl style="color: #F88600;font-size: 16px;margin-top: 69px; ">修改商品</dl>
           	<div style=" margin-top:10px; margin-left:30px; height:100px; width:300px;">
            	<div style="height:80px; width:100px; margin-top:10px; text-align:center;"><img src="../img/头像.png"/>
                <div style=" margin-left:115px;  width:150px; text-align:center; margin-bottom:1px;"><input type="file" class="text" name="proUrl" /></div>
                </div>
            </div>
            <form class="manage">
                <table class="form" >
                    ...
                    <!--<tr>
                        ...
                        <td class="field">折扣：</td>
                       <td><input type="number"   class="text tiny" step="0.05" max="1" min="0.1" name="zhekou" style="border:1px solid #CCCCCC; width:70px;"/> 折</td>

                    </tr>
                    <tr>
                        <td class="field">库存：</td>
                        <td><input type="text" class="text tiny" name="stock" id="qq" value="100"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td><label class="ui-blue"><input type="submit" name="submit" value="确定修改" /></label></td>
                    </tr>
                </table>
