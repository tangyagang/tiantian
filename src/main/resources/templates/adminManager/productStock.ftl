...
<head>
    ...
    <script type="text/javascript" src="../js/ProdoctStock.js"></script>
            ...
            $("#first_page").click(function(){
                ...
                if(pageNo > 1){
                    ...
                    window.location.href=
                            "${request.contextPath}/adminManager/productStock?pageNo="+pageNo;
                }
            })
            ...
            <div class="ms-side">
                <article class="side-menu side-menu-off">
                    <dl class="side-menu-tree">
                        ...
                        <dd><a href="${request.contextPath}/adminManager/productStock"  style="color:#f70"><span ></span>出售中的商品</a></dd>
            ...
            <table class="yz-table2-table">
                ...
                <table class="yz-table2-title" style="width: 985px;">
                    ...
                    <tr class="list-table-tr1">
                        ...
                        <td class="list-table2-td5">下架</td>
                ...
                <from>
						<#--<div style="font-size: 12px"><input type="checkbox" onClick="checkboxAllOnclick(this)"/>全选 <input type="button" value="下架" class="quanxuan"> <input type="button" value="删除" class="buy_delete"><input type="button" value="上架" class="shangjiaa"></div>-->
                    ...
                    <td>
						...
						<div class="yz-table-td-div2">
							...
							<table>
								...
								<td class="list-table2-body-td2">
									<input style="width: 50px;" size="1" disabled="disabled" value="${product.proPrice}" name="proPrice" class="qw" type="text"></td>
								<td class="list-table2-body-td2">
									<input style="width: 50px;" class="list-table-input" size="1" disabled="disabled" value="${product.stock}" name="stock" type="text"></td>
								...
								<#--<input type="number" class="text tiny" step="0.05" max="1" min="0.1" name="zhekou"
									...
									<input style="width: 50px;" class="qw" type="text" disabled="disabled" value="${product.newPrice}" name="newPrice"></td>
								<td class="list-table2-body-td5"><a href="${request.contextPath}/adminManager/productLowerShelf?proIds=${product.proId}">下架</a></td>
								<td class="list-table2-body-td5"><a href="${request.contextPath}/adminManager/productDetail?proId=${product.proId}">查看</a></td>
								</tbody>
							</table>
						</div>
                        ...
                        <div class="yz-table2-td-div-box">
                            <div class="yz-table-td-div">
                            	&lt;#&ndash;<input onClick="checkboxOnclick(this)" type="checkbox" class="li_input" name="store1"/>
                            （状态显示栏，下架显示值为橘色，一般为蓝色）&ndash;&gt;
                            </div>
                            <table >
                                <tbody class="list-table">
                                <from>
                                    <td class="list-table-body-td1" style="text-align: left"><img src="../img/yz/user1.png"><a href="">商品名称</a></td>
                                    <td class="list-table2-body-td2"><input size="1" value="1500" name="proPrice" class="qw"> </td>
                                    <td class="list-table2-body-td2" >
                                        <input class="list-table-input" size="1" value="10" name="stock" class="qq">
                                    </td>
                                    <td class="list-table-body-td3">电器</td>
                                    <td class="list-table-body-td4">
                                       <!-- <select>
                                            <option>100%</option>
                                            <option>95%</option>
                                        </select>&ndash;&gt;
                                        <input type="number" class="text tiny" step="0.05" max="1" min="0.1" name="zhekou" style="border:1px solid #CCCCCC; width:70px;" value="0.5"/> </td>

                                        </td>
                                    <td class="list-table2-body-td5" ><input type="submit" value="上架" class="shangjia"></td>
                                    <td class="list-table2-body-td5"><input type="submit" value="删除" class="shanchu"></td>
                                </from>
                                </tbody>
                            </table>
                        </div>
