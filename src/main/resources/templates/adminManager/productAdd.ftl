...
<div id="yz-center" class="personal-member">
    <div class="cont">
            ...
            <div class="ms-side">
                <article class="side-menu side-menu-off">
                    <dl class="side-menu-tree">
                        ...
                        <dd><a href="${request.contextPath}/adminManager/productAdd" style="color:#f70"><span ></span>发布商品</a></dd>
        ...
        <div style="margin-top: 30px;width: 1068px; margin: 15px 0 30px 170px;">
            ...
            <form class="manage" action="${request.contextPath}/adminManager/proAdd" method="post" enctype="multipart/form-data">
                <table class="form" >
                    <tr>
                            ...
                            <select id="pcId1" name="pcId1">
                                  <#list cateList as cate>
                                      <option value=${cate.pcId}
                                      	<#if cate_index == 0>selected = "selected"</#if>
                                      >${cate.pcName}</option>
								  </#list>
                            </select>
                        </td>
                                ...
                                <#list cateList as cate>
                                    <#if cate_index == 0>
										<#list cate.productCategorys as type2>
                                            ...
                                            <#if type2_index == 0>selected = "selected"</#if>
                                            >${type2.pcName}</option>
										</#list>
									</#if>
								</#list>
										...
										<#list cate.productCategorys as type2>
											<#if type2_index == 0>
												<#list type2.productCategorys as type3>
                                                    ...
                                                    <#if type3_index == 0>selected = "selected"</#if>
                                                    >${type3.pcName}</option>
												</#list>
											</#if>
										</#list>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px"><input style="width: 100px;" type="text" class="text tiny qw"  name="proPrice" ="qw" value=""/> 元</td>
                    </tr>
                    <tr>
                    <!--<tr>
                       ...
                       <td style="font-size: 12px"><#--<input type="number"   class="text tiny" step="0.05" max="1" min="0.1" name="zhekou" style="border:1px solid #CCCCCC; width:70px;"/> 折-->
                           <input style="width: 100px;" type="text" class="text tiny qw" name="newPrice"/> 元
					   </td>

                    </tr>
                    <tr>
                        <td class="field">库存：</td>
                        <td><input style="width: 100px;" type="text" class="text tiny" name="stock" id="qq" value=""/></td>
                    </tr>
                    <tr>
