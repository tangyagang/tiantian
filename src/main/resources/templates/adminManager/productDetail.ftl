...
<head>
    ...
    <script type="text/javascript" src="../js/ProdoctAdd.js"></script>
</head>
<style>
    a{
        color: #000000;
...
<div id="yz-center" class="personal-member">
    <div class="cont">
        ...
        <div style="margin-top: 30px;width: 1068px; margin: 15px 0 30px 170px;">
            <dl style="color: #F88600;font-size: 16px;margin-top: 69px;">商品详情</dl>
            <div style=" margin-top:5px; margin-bottom:5px; height:95px; overflow:hidden;">
            	<div style="text-align:center; width:60px; height:20px; margin-top:50px; margin-left:100px;">商品缩图</div>
                <div style=" margin-left:170px; width:100px; margin-top:-45px; text-align:center;"><img style="width: 60px;height: 60px;" src="${request.contextPath}/${product.proUrl}"/></div>
             </div>
            <form class="manage" action="${request.contextPath}/adminManager/productStock">
                <table class="form" >
                    <tr>
                        <td class="field">商品名称：</td>
                        <td><span>${product.proName}</span></td>
                        <!--<td ><input type="text" class="text" name="proName" /></td>-->
                    </tr>
                    <tr>
                        <td class="field">所属大类：</td>
                        <td>
                        <span><#list cateList as cate>
                                        <#if cate.pcId == product.productCategory.productCategory.productCategory.pcId>${cate.pcName}</#if>
						</#list></span>
                           <!-- <select name="pcId">
                            ...
                            <span> <#list cateList as cate>
                                    <#if cate.pcId == product.productCategory.productCategory.productCategory.pcId>
										<#list cate.productCategorys as type2>
                                            <#if type2.pcId == product.productCategory.productCategory.pcId>${type2.pcName}</#if>
										</#list>
									</#if>
							</#list></span>
                        </td>
										...
										<#list cate.productCategorys as type2>
											<#if type2.pcId == product.productCategory.productCategory.pcId>
												<#list type2.productCategorys as type3>
                                                    <#if type3.pcId == product.productCategory.pcId>${type3.pcName}</#if>
												</#list>
											</#if>
										</#list>
									</#if>
                   ...
                   <!-- <tr>
                        ...
                        <td style="font-size: 12px"><input type="file" class="text" name="proUrl" /></td>
                    </tr>-->
                    <tr>
                        <td class="field">商品价格：</td>
                        <td><span>${product.proPrice}元</span></td>
                       <!-- <td style="font-size: 12px"><input type="text" class="text tiny"  name="proPrice" id="qw" value="1"/> 元</td>-->			
                    </tr>
                    <tr>
                    <!--<tr>
						<td class="field">折扣：</td>
						<c:if test="<#--${requestScope.product.spatialPrice eq 0}-->"></c:if>
						<td><input type="number" value="<#--${requestScope.product.isSpatial eq 1 ? product.spatialPrice/product.price : 1}-->" class="text tiny" step="0.05" max="1" min="0.1" name="zhekou" /> 折</td>
					</tr>-->
                        <!--<td class="field">折扣：</td>
                        <td>
                            <select name="isPrice">
                       ...
                       <!--<td><input type="number"   class="text tiny" step="0.05" max="1" min="0.1" name="zhekou" style="border:1px solid #CCCCCC; width:70px;"/>-->
                        <td><span><#if product.isPrice==1>${product.newPrice}</#if>元</span></td>

                    </tr>
                    <tr>
                        <td class="field">库存：</td>
                        <td><!--<input type="text" class="text tiny" name="stock" id="qq" value="100"/>-->
                    ...
                    <#list product.proImgs as proImg>
                         <tr>
                             ...
                             <!--<td style="font-size: 12px"><input type="file" class="text" name="proUrl" /></td>-->
                             <td><img style="width: 400px;height: 350px;margin:15px auto;" src="${request.contextPath}/${proImg.proImgUrl}"/></td>
                         </tr>
                    </#list>
                    <tr>
                        ...
                        <td>
                           ...
                           <span><#if product.description??>${product.description}</#if></span>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        <td><label class="ui-blue" style=" margin-left:220px;"><input type="submit" name="submit" value="确定"  /></label></td>
                    </tr>
                </table>
