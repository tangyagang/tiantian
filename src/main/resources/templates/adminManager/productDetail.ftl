    ...
    <div class="cont">
        ...
        <div style="margin-top: 30px;width: 1068px; margin: 15px 0 30px 170px;">
            ...
            <div style=" margin-top:5px; margin-bottom:5px; height:95px; overflow:hidden;">
                ...
                <div style=" margin-left:170px; width:100px; margin-top:-45px; text-align:center;"><img src="img/iphone-01.png"/></div>
             </div>
            <form class="manage">
                <table class="form" >
                    <tr>
                        <td class="field">商品名称：</td>
                        <td><span>电子商品</span></td>
                   ...
                   <!-- <tr>
                    ...
                    <tr>
                        ...
                        <!--<td style="font-size: 12px"><input type="file" class="text" name="proUrl" /></td>-->
                        <td><img src="img/message-01.png"/></td>
                    </tr>
                    <tr>
                        <td class="field">商品展示图：</td>
                       	<!-- <td style="font-size: 12px"><input type="file" class="text" name="proUrl" /></td>-->
                        <td><img src="img/iphone-01.png"/></td>
                    </tr>
                    <tr>
