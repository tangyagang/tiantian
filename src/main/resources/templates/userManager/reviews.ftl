                ...
                <div class="server-wrapper">
                    <div class="server-tab" style="margin-top: 20px;">
                        <div style="width: 100%;    display: inline-block; margin-top: 20px;">
                            <form action="${request.contextPath}/userManager/addScore?orderId=${order.orderId}" method="post">
                                <h3 style="font-size: 14px;color: #333333;width: 1000px;"><span
                                        style="float: left;background-color: #F2873B;height: 15px;width: 4px;margin-top: 10px;margin-right: 10px;"></span>评价宝贝
                                </h3>
                                <p style="width: 99%;font-size: 14px;color: #333333;margin-top: 20px; margin-left: 30px; font-weight: bold;">
                                <span style="margin-left: 780px;">卖家： <font
                                        style="color: #F37B1D;">&nbsp;&nbsp;${order.orderDetails[0].shop.shopName}</font></span></p>
                                <div style="width: 150px;height: 200px;float: left;margin-left: 50px;">
                                    <img src="../img/宝贝收藏/组-56.png" style="height:150px;width:150px;"/>
                                    <p style="line-height:40px;text-align: center;">${order.orderDetails[0].product.proName}</p>
                                </div>
                                <div style="margin-left: 70px;width: 650px;float: left;">
                                    <div>
                                    <span style="display: inline-block;width: 100px;line-height: 100px;">
                                        <input name="score" value="90" type="radio"><img src="../img/好评.png"/></span>
                                        <span style="display: inline-block;width: 100px;line-height: 100px;">
                                        <input name="score" value="60" type="radio"><img src="../img/中评.png"/></span>
                                        <span style="display: inline-block;width: 100px;line-height: 100px;">
                                        <input name="score" value="30" type="radio"><img src="../img/差评.png"/></span>
                                    </div>
                                    <div style="margin-top: 20px;">
                                    <textarea maxlength="" name="details"
                                              style="width: 650px; height: 200px; display: block; margin: 10px 0;border: 1px #cecece solid;resize: vertical;"></textarea>
                                    </div>
                                    <div style="margin-top: 20px;">
                                        <input type="hidden" name="proId" value="${order.orderDetails[0].product.proId}">
                                        <input style="width: 160px; color: #fff; background: #009966; border: none; font-size: 14px; font-weight: bold; text-align: center; line-height: 40px; border-radius: 8px; cursor: pointer;"
                                               type="submit" value="发表评论"><#if message??><span style="color: red;margin-left: 20px;">${message}</span></#if>
                                    </div>
                                </div>
                            </form>
                        </div>
