								...
								<div class="form-list tab-switch personal-wrap-show">
									...
									<div class="control-group clearfix">
										...
										<div class="controls lh26">
											...
											<a >修改</a>-->
											<input style="color: #333;" type="text" class="text" name="email" value="<#if user.email??>${user.email }</#if>">
										</div>
									</div>
									<div class="control-group clearfix">
										...
										<div class="controls">
											...
											<input style="color: #333;" value="<#if user.birthday??>${user.birthday?string("yyyy-MM-dd")}</#if>" type="date" class="text date-color" name="birthday" >
									...
									<div class="control-group clearfix priority-high">
										...
										<div class="controls">
											<div id="zhen" datas-id="" class="citySelect cityboxbtn">
												<select style="color: #333;" id="provinceId">
												...
												<select style="color: #333;" id="cityId">
													<#list addressList as pro>
												...
												<select style="color: #333;" id="areaId" name="areaId">
													<#list addressList as pro>
														<#if  areas?? && pro.provinceId == areas.cities.provinces.provinceId>
															<#list pro.citieses as cities>
