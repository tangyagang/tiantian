						...
						<div class="server-wrapper">
							<div class="server-tab" style="margin-top: 26px;">
								<div style=" float: left;vertical-align: bottom;text-align: center;">
									<div style="width: 1000px;padding: 10px;float: left;margin-left:0px;margin-bottom:180px;background-color: none;height: 250px;">
										...
										<div style=" padding:10px ;margin-top: -10px;text-align: center;float: left;">
											<#list list as product>
												<div style="width: 210px;height: 280px; padding:5px;float: left;margin-left: 20px;margin-bottom:20px;background-color: #fff;">
                                                    <img src="${request.contextPath}/${product.proUrl}" style="width: 200px;height: 200px;"/>
                                                    <p style="width: 180px;"></p>
                                                    <div>
                                                        <span style="text-align:left;color: #f78642;font-size: 14px;display: inline-block;margin: 0px;">
															<#if product.isPrice == 1>¥${product.newPrice}</#if><#if product.isPrice == 0>¥${product.proPrice}</#if>
														</span>
                                                        <span style="margin-top: 10px;color: #949494;text-decoration: line-through;">
															<#if product.isPrice == 1>¥${product.proPrice}</#if>
														</span>
                                                    </div>
                                                    <p style="margin-bottom: 5px;text-align: center;margin-left: 10px;color: #686868;">${product.proName}</p>
                                                    <p style="margin-bottom: 5px; ">${product.shop.address}</p>
                                                </div>
											</#list>
										</div>
									</div>
