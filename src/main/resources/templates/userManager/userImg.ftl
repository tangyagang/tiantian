...
<head>
    ...
    <link rel="stylesheet" href="../css/safe/personal_img.min.css"/>
...
<div class="ng-toolbar">
    <div class="ng-toolbar-con wrapper">
        <div class="ng-toolbar-left">
            ...
            <div class="ng-bar-node-box ng-site-nav-box">
                <a href="" class="ng-bar-node ng-bar-node-site">
                    <span><img src="../img/daohang.png" style="margin-right: 5px;"/>网站导航</span><em
        ...
        <div class="ng-toolbar-right">
            <a href="" class="ng-bar-node username-bar-node username-bar-node-showside" rel="nofollow"
               style="display:none;">
                <span id="">吉米小子</span>
                <em class="hasmsg ng-iconfont"></em>
            </a>
            <div class="ng-bar-node-box username-handle" style="display: block;">
            ...
            <div class="ng-bar-node-box myorder-handle">
                <a class="ng-bar-node ng-bar-node-fix touch-href ng-bar-node-pr5"><span>我的买啦</span><em
            ...
            <div class="ng-bar-node-box mysuning-handle">
                <a href="http://my.suning.com" rel="nofollow"
                   class="ng-bar-node ng-bar-node-fix touch-href ng-bar-node-pr5"><span>收藏夹</span><em
                        class="ng-iconfont down"></em></a>
        ...
        <div class="header-menu">
            <div class="ms-logo">
                <a class="ms-head-logo" name="Myyigou_index_none_daohangLogo"><span
                        style="font-size: 30px;color: #fff;font-weight: bold;    line-height: 28px;;">我的买啦</span></a>
        ...
        <div class="cont-main">
            <div class="main-wrap mt15">
                ...
                <div class="main-wrap-main">
                    ...
                    <form method="post" name="user" action="${request.contextPath}/userManager/userImgModify"
                        ...
                        <div class="user-profile clearfix">
                            <div class="user-profile-wrap">
                                ...
                                <p>仅支持JPG、GIF、PNG图片文件，且文件小于5M</p><br>
                                    <#--判断是否上传文件-->
                                    <#if msg??>
                                        <span>${msg}</span><br>
                                    <#else >
                                ...
                                <div class="profile-avatar">
                                    ...
                                    <img src="${request.contextPath}/${user.userUrl}" height="200" width="200">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group clearfix priority-low">
                            ...
                            <div class="save">
                                ...
                                <input class="ms-stand-btn1"  type="submit" value="提 交">
                            </div>
