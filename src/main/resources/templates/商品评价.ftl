							...
							<div class="server-tab" style="margin-top: 20px;">
								<div style=" width: 503px;height: 130px;float: left;border: 1px #CCC solid;">
									...
									<div style="float: left;width: 50%;">
										<p style="margin-left: 42px;">会员名:&nbsp;&nbsp;shir0kj</p>
										<p style="margin-left: 42px;">地&nbsp;&nbsp;址:&nbsp;&nbsp;北京市海淀区中关村</p>
										</div>
								...
								<div style="width: 100%;    display: inline-block; margin-top: 20px;">
									...
									<p style="width: 99%;font-size: 14px;color: #333333;margin-top: 20px; margin-left: 30px; font-weight: bold;"><span style="margin-left: 780px;">好评率:<font style="color: #F37B1D;">&nbsp;&nbsp;100.00%</font></span></p>
								...
								<!--  <li><a href="#about" data-toggle="tab">售后评价</a></li>-->
							     ...
							     <select style="width: 60px;margin-left: 50px;height: 20px;">
							     	<option selected="">评价</option>
									 <option value="">好评</option>
									 <option value="">中评</option>
									 <option value="">差评</option>
							     </select>
							     <select style="width: 60px;margin-left:26px;height: 20px;">
							     	<option selected="">评论</option>
									 <option value="">有评论内容</option>
									 <option value="">无评论内容</option>
							     </select>
								...
								<div class="tab-content" style="margin-top: 30px;">
								  ...
								  <div id="profile" class="tab-pane active">
							    	...
							    	<span class="fenye"><</span><span class="fenye">1</span><span class="fenye">2</span><span class="fenye">3</span><span class="fenye">4</span><span class="fenye">5</span>.....<span class="fenye">></span>共1页，到<input type="text" value="1" style="width: 20px;margin-left: 10px;margin-right: 10px;" />页<button  style="background-color: #f95555;padding: 3px;border: 0px;color: #fff;margin-left: 10px;">确认</button>
							    		</p>
								  	</div>
