...
<title>三级分类</title>
<link  href="css/detail2.css" type="text/css" rel="stylesheet"/>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".s_btn").click(function () {
                ...
                window.location.href="${request.contextPath}/detail2?pcId=${pcId}&proName="+proName;
            });
            //分页
            $("#first_page").click(function(){
                ...
                if(pageNo > 1){
                    pageNo = 1;
                    $("#current").val(pageNo);
                    window.location.href="${request.contextPath}/detail2?pcId=${pcId}&pageNo="+pageNo+"&proName="+proName;
                }
            })
            ...
            $("#orderPrice").change(function () {
                ...
                window.location.href = "${request.contextPath}/detail2?pcId=${pcId}&choose="+orderPrice;
            })
        });
    </script>
</head>
        ...
        <div class="test2">
            <div class="A1">
               <#if user??>
                    ...
                    <a href="${request.contextPath}/exit?msg=detail2">退出登录</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
               <#else >
...
<section class="center_class">
	<div class="f1">
    	全部&nbsp;&nbsp;> &nbsp;&nbsp;<strong>"${productCategory.pcName}"</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;共${page.totalCount}个商品
    </div>
	<div class="f2">
    	<div class="f2_main1">
        	<span>分类</span>
            <div class="f2_main1_a1">
                <#list productCategorys>
                <ul>
                    <#items as productCategory>
                        <li><a href="#">${productCategory.pcName}</a></li>
                    </#items>
                </ul>
                </#list>
            </div>
