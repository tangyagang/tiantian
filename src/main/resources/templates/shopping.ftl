      ...
      <div class="shop">
      		<ul>
            	<li>
                	...
                	<div class="shopImg">
                    	<img src="img/center3.jpg" width="60px" height="70px" alt=""/>
                    </div>
                    <div class="shopText">
                    	<div class="clear">
                              <h5>宝贝许愿坊 童装女装套装 </h5>    
                        </div>
                        <p class="price">￥100.3</p>
                        <div class="clear">
                               <div class="plush">
                               ...
                               <strong class="J_smallTotalPrice">￥100.3</strong>
                ...
                <li>
                    ...
                    <div class="shopText">
                        ...
                        <div class="clear">
                               ...
                               <strong class="J_smallTotalPrice">￥12.3</strong>
                               	<a href="#" class="shoucang">加入收藏</a>
                                <a href="#" class="close J_btnDelete">删除</a>
                         </div>
                    </div>
                ...
                <li>
                    ...
                    <div class="shopText">
                        ...
                        <div class="clear">
                            ...
                            <strong class="J_smallTotalPrice">￥15</strong>
                            <a href="#" class="shoucang">加入收藏</a>
                            <a href="#" class="close J_btnDelete">删除</a>
                        </div>
                    </div>
                ...
                <li>
                    ...
                    <div class="shopText">
                        ...
                        <div class="clear">
                            ...
                            <strong class="J_smallTotalPrice">￥2.8</strong>
                            <a href="#" class="shoucang">加入收藏</a>
                            <a href="#" class="close J_btnDelete">删除</a>
                        </div>
                    </div>
...
<div id="fenye">
	<div class="fenye_main">
        <span class="fenye_changOut"><a href="#">首页</a></span>
         <span class="fenye_changIn"><a href="#">上页</a></span>
        <span class="fenye_test"><a href="#">1</a></span>
        <span class="fenye_test3"><a href="#">2</a></span>
        <span class="fenye_test2"><a href="#">3</a></span>
        <span class="fenye_test1"><a href="#">1000</a></span>
         <span class="fenye_changIn"><a href="#">下页</a></span>
        <span class="fenye_changIn"><a href="#">末页</a></span>
    </div>
</div>      
