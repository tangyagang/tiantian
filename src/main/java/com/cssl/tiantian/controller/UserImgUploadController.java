...
public class UserImgUploadController {
    ...
    @Autowired
    public UserImgUploadController(ResourceLoader resourceLoader) {
    ...
    public String upload(@ModelAttribute("user") User user,
        ...
        return "forward:/userManager/userInfoImg";
    }
/*  File upload = null;
        try {
